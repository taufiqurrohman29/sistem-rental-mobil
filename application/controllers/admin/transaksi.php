...
class Transaksi extends CI_Controller{
	...
	public function download_pembayaran($id)
	{
		...
		$filePembayaran = $this->mobil_model->downloadPembayaran($id);
	...
	public function transaksi_selesai_aksi()
	{
		...
		$data2 = $this->mobil_model->get_where($where,'transaksi')->row();
		$where2 = array('id_mobil' => $data2->id_mobil);
		$data3 = array('status' => '1');
		$this->mobil_model->update_data('mobil',$data3,$where2);
		$this->mobil_model->update_data('transaksi',$data,$where);
